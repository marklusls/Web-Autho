     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                 <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                     <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">My Consultations</p></div></a>
                 </td>
             </tr>
             <tr class="menu-row" >
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Consultations</p>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">My Consultations (<?php echo $list110->num_rows; ?>) </p>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <center>
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Empty for now</p>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Consultation Details</p><br><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Consultation: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
