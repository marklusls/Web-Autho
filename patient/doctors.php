            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Scheduled Consultations</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Go to doctor consultations?</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
                            You want to view all consultations by <br>('.substr($name,0,40).').
